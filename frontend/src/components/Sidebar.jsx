...
//   ChevronRight,
//   AlertTriangle,
//   Zap, // Added Zap for high-tech look
//   Cpu // Added Cpu for AI/System
// } from 'lucide-react';

// const Sidebar = () => {
//   const navigate = useNavigate();
//   const location = useLocation();
//   // Set default expanded section to 'safety' for high-priority items
//   const [expandedSection, setExpandedSection] = useState('safety'); 
...
//   // --- Menu Data (Slight Icon/Name Updates for AI/Rockfall Theme) ---
//   const mainMenuItems = [
//     { id: 'dashboard', name: 'Dashboard', icon: LayoutDashboard, badge: null },
//     { id: 'analytics', name: 'Performance', icon: BarChart3, badge: null },
//     { id: 'reports', name: 'Audit Reports', icon: FileText, badge: '3' },
//   ];

//   const safetyMenuItems = [
//     { id: 'prediction', name: 'AI Prediction', icon: Cpu, badge: 'ML' },
//     { id: 'alerts', name: 'Critical Alerts', icon: Bell, badge: '5' },
//     { id: 'riskmap', name: 'Geological Map', icon: MapPin, badge: null },
//     { id: 'imageanalysis', name: 'Data Visualization', icon: Camera, badge: null },
//     { id: 'livewebcam', name: 'Sensor Streams', icon: Video, badge: 'Live' },
//     { id: 'pitholealarm', name: 'Pore Pressure Alarm', icon: AlertTriangle, badge: '2' },
//     { id: 'environmental', name: 'Environmental Data', icon: Shield, badge: null },
//   ];

//   const systemMenuItems = [
//     { id: 'smsalerts', name: 'Comms Setup', icon: MessageSquare, badge: null },
//     { id: 'activity', name: 'System Log', icon: Activity, badge: null },
//     { id: 'settings', name: 'Settings', icon: Settings, badge: null },
//   ];


//   // --- Menu Section Component (Updated Styling) ---
//   const MenuSection = ({ title, items, sectionKey }) => (
//     <div className="mb-4">
//       <button
//         onClick={() => setExpandedSection(expandedSection === sectionKey ? null : sectionKey)}
//         className="flex items-center justify-between w-full px-3 py-2 text-xs font-bold text-gray-500 uppercase tracking-widest transition-colors"
//       >
//         <span>{title}</span>
//         <ChevronRight 
//           className={`h-3 w-3 transition-transform duration-200 ${
//             expandedSection === sectionKey ? 'rotate-90 text-cyan-400' : ''
//           }`} 
//         />
//       </button>
...
//                 <button
//                   onClick={() => handleNavigation(item.id)}
//                   className={`group w-full flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-200 ${
//                     getActiveItem() === item.id
//                       ? 'bg-indigo-600/70 border border-indigo-500/50 text-white shadow-xl shadow-indigo-500/20' // Strong active state
//                       : 'text-gray-400 hover:bg-gray-700/50 hover:text-white' // Dark hover state
//                   }`}
//                 >
//                 <div className="flex items-center">
//                   <item.icon className={`h-4 w-4 mr-3 ${
//                     getActiveItem() === item.id ? 'text-cyan-300' : 'text-gray-500 group-hover:text-cyan-400'
//                   }`} />
//                   <span className="font-medium">{item.name}</span>
//                 </div>
//                 {item.badge && (
...
//                     getActiveItem() === item.id 
//                       ? 'bg-white/10 text-cyan-300' // Active badge in high-contrast light color
//                       : item.badge === 'Live' || item.badge === 'ML' // Use specific colors for high-value badges
//                         ? 'bg-cyan-900/50 text-cyan-400 animate-pulse' 
//                         : item.badge === '5' || item.badge === '2' 
//                           ? 'bg-red-900/50 text-red-400' // Danger badges in red
...
//   return (
//     // Dark Theme: bg-gray-900, darker border
//     <aside className="bg-gray-900 border-r border-gray-800 w-64 hidden md:block sticky top-0 h-screen overflow-y-auto">
//       <div className="p-4">
        
//         {/* Logo/Branding Header */}
//         <div className="p-2 mb-8 flex items-center border-b border-gray-800 pb-4">
//           <Zap className="h-6 w-6 text-cyan-400 mr-3" />
//           <span className="text-xl font-extrabold text-white tracking-wider">
//             Rockfall <span className="text-indigo-400">AI</span>
//           </span>
//         </div>

//         {/* Quick Stats - Styled for Dark Theme */}
//         <div className="mb-6 p-4 bg-gray-800 rounded-xl border border-indigo-700/50 shadow-lg">
//           <div className="flex items-center space-x-3 mb-3">
//             <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center shadow-md">
//               <AlertTriangle className="h-4 w-4 text-white" />
//             </div>
//             <div>
//               <h3 className="text-sm font-semibold text-white">Stability Status</h3>
//               <p className="text-xs text-gray-400">Real-time geological score</p>
//             </div>
//           </div>
//           <div className="grid grid-cols-2 gap-3">
//             <div className="text-center">
...
//             </div>
//             <div className="text-center">
//               <div className="text-xl font-extrabold text-green-500">47</div>
//               <div className="text-xs text-gray-400">Stable Zones</div>
//             </div>
//           </div>
//         </div>
...
//           <MenuSection title="Core Dashboard" items={mainMenuItems} sectionKey="main" />
//           <MenuSection title="Predictive Safety" items={safetyMenuItems} sectionKey="safety" />
//           <MenuSection title="Platform Management" items={systemMenuItems} sectionKey="system" />
//         </nav>

//         {/* Footer/Version Info */}
//          <div className="mt-8 pt-4 border-t border-gray-800">
//             <p className="text-xs text-gray-600 text-center">RockGuard AI Platform v2.1</p>
//         </div>
//       </div>
//     </aside>
//   );
  ...
  return (
    ...
    <aside className="bg-gray-900 border-r border-gray-800 w-64 hidden md:block sticky top-0 h-screen overflow-y-auto">
      <div className="p-4">
        ...
        {/* New Header: Clean Icon and System Status */}
        {/* <div className="p-2 mb-8 flex items-center justify-center border-b border-gray-800 pb-4">
          <div className="relative"> */}

            {/* Zap Icon for Energy/Prediction */}
          ...
          <span className="text-lg font-semibold text-gray-400 tracking-wider ml-3 hidden lg:inline">
            SYSTEM ONLINE
          </span>
        </div> */}
